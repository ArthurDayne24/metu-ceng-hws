...
private:
    const static int bufferSize = 28;
    ...
    // params: file name, buffer, capacity of buffer
    // return: number of bytes read from file
    int read_to_buffer(const std::string & , unsigned char[], int);
...
public:
    ...
    Attack(const std::string & , const std::string & , const std::string & );
