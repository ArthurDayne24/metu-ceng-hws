...
#Both routers use this class sşnce they perform same
class RouterNode:
    ...
    #thread responsible with connection to broker
    def worker_to_broker(self):
        ...
        while True:
            ...
            #Store and forward. Makes sure there is no message with insufficient len
