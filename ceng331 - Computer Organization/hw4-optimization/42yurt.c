        ...
        for (k = 0; k < n; k++) {
            ...
            for (i = 0; i < n; i++) {
                ...
                for (j = 0; j < nd; j++) {
                    ...
                    dstij[32] += r * src2ij[32];
                    dstij[33] += r * src2ij[33];
                    dstij[34] += r * src2ij[34];
                    dstij[35] += r * src2ij[35];
                    dstij[36] += r * src2ij[36];
                    dstij[37] += r * src2ij[37];
                    dstij[38] += r * src2ij[38];
                    dstij[39] += r * src2ij[39];
                    dstij[40] += r * src2ij[40];
                    dstij[41] += r * src2ij[41];
                    dstij[42] += r * src2ij[42];
                    dstij[43] += r * src2ij[43];
                    dstij[44] += r * src2ij[44];
                    dstij[45] += r * src2ij[45];
                    dstij[46] += r * src2ij[46];
                    dstij[47] += r * src2ij[47];
                    dstij[48] += r * src2ij[48];
                    dstij[49] += r * src2ij[49];
                    dstij[50] += r * src2ij[50];
                    dstij[51] += r * src2ij[51];
                    dstij[52] += r * src2ij[52];
                    dstij[53] += r * src2ij[53];
                    dstij[54] += r * src2ij[54];
                    dstij[55] += r * src2ij[55];
                    dstij[56] += r * src2ij[56];
                    dstij[57] += r * src2ij[57];
                    dstij[58] += r * src2ij[58];
                    dstij[59] += r * src2ij[59];
                    dstij[60] += r * src2ij[60];
                    dstij[61] += r * src2ij[61];
                    dstij[62] += r * src2ij[62];
                    dstij[63] += r * src2ij[63];
