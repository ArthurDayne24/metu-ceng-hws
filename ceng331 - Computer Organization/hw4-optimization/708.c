        ...
        for (int i = n; i--; ) {
            ...
            for (int j = n; j--; ) {
                ...
                for (int k = nd; k--; ) {
                    ...
                    acc1 += src1ik[1 ]*src2cjk[1 ];
                    acc0 += src1ik[2 ]*src2cjk[2 ];
                    acc1 += src1ik[3 ]*src2cjk[3 ];
                    acc0 += src1ik[4 ]*src2cjk[4 ];
                    acc1 += src1ik[5 ]*src2cjk[5 ];
                    acc0 += src1ik[6 ]*src2cjk[6 ];
                    acc1 += src1ik[7 ]*src2cjk[7 ];
                    acc0 += src1ik[8 ]*src2cjk[8 ];
                    acc1 += src1ik[9 ]*src2cjk[9 ];
                    acc0 += src1ik[10]*src2cjk[10];
                    acc1 += src1ik[11]*src2cjk[11];
                    acc0 += src1ik[12]*src2cjk[12];
                    acc1 += src1ik[13]*src2cjk[13];
                    acc0 += src1ik[14]*src2cjk[14];
                    acc1 += src1ik[15]*src2cjk[15];
                    acc0 += src1ik[16]*src2cjk[16];
                    acc1 += src1ik[17]*src2cjk[17];
                    acc0 += src1ik[18]*src2cjk[18];
                    acc1 += src1ik[19]*src2cjk[19];
                    acc0 += src1ik[20]*src2cjk[20];
                    acc1 += src1ik[21]*src2cjk[21];
                    acc0 += src1ik[22]*src2cjk[22];
                    acc1 += src1ik[23]*src2cjk[23];
                    acc0 += src1ik[24]*src2cjk[24];
                    acc1 += src1ik[25]*src2cjk[25];
                    acc0 += src1ik[26]*src2cjk[26];
                    acc1 += src1ik[27]*src2cjk[27];
                    acc0 += src1ik[28]*src2cjk[28];
                    acc1 += src1ik[29]*src2cjk[29];
                    acc0 += src1ik[30]*src2cjk[30];
                    acc1 += src1ik[31]*src2cjk[31];
